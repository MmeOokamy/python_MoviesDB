...
# movies
search_button = Button(app.top_frame, text="?", command=app.search)
...
search_detail_button = Button(app.content_frame, text="?", command=app.detail)
